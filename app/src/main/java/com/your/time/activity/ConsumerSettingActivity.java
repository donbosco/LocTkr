...
public class ConsumerSettingActivity extends YourTimeActivity implements RestCaller{

    private static final String TAG = "ConsumerSettingActivity";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        YourTimeUtil.controlMenuShowHide(this,menu,R.id.consumer_action_settings,currentActivity);
        return true;
    }
